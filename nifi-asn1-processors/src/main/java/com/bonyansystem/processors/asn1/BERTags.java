...
public interface BERTags
{
    ...
    public static final int CONSTRUCTED         = 0x20; // decimal 32   1=CONSTRUCTED or 0=PRIMITIVE
    public static final int APPLICATION         = 0x40; // decimal 64
    public static final int TAGGED              = 0x80; // decimal 128  CONTENT_SPECIFIC tag
    public static final int UNIVERSAL           = 0x00; // decimal 0    UNIVERSAL data type
    public static final int PRIVATE             = 0xC0; // decimal 192  PRIVATE data types
